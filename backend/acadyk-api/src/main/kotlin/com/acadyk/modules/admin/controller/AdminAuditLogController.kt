...
import com.acadyk.modules.admin.dto.AdminAuditLogResponse
...
class AdminAuditLogController(
    ...
    @GetMapping
    fun getAuditLogs(): ResponseEntity<ApiResponse<List<AdminAuditLogResponse>>> {
        val logs = adminUserService.getAuditLogs()
