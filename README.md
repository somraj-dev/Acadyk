...
Acadyk is an enterprise academic, professional, and career discovery network built with **Flutter (Mobile & Web)** and **Kotlin Spring Boot 3.3.x (Enterprise Core Backend)**.
...
Acadyk/
├── apps/
│   └── mobile/                  # Flutter Mobile Application (Android, iOS & Web)
│       ├── android/
│       ├── ios/
│       ├── web/
│       ├── assets/
...
- **Authentication**: Supabase & Firebase Authentication SDK + `flutter_secure_storage`
