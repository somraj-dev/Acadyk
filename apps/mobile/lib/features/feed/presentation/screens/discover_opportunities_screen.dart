...
class _DiscoverOpportunitiesScreenState extends State<DiscoverOpportunitiesScreen> {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => EventDetailScreen(
              eventData: {
                'title': 'SLAB Hackathon -\nMITS (Gwalior)',
                'dates': op['dates'] ?? 'Saturday 22 August',
                'location': op['location'] ?? 'Madhav Institute of Technology & Science, Gwalior',
                'locationCity': 'Gwalior, Madhya Pradesh',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onLongPress: () {
                _showBannerPopup(context, op['bannerUrl']!, op['title']!);
              },
              onDoubleTap: () {
                setState(() {
                  if (isLiked) {
            ...
            // 7. Social Reaction details bottom bar (Like & Save only)
            Row(
              children: [
                GestureDetector(
                  onTap: () {
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(isSaved ? 'Removed from saved opportunities' : 'Saved to your opportunities'),
  ...
  void _showBannerPopup(BuildContext context, String bannerUrl, String title) {
    showDialog(
      context: context,
        ...
        return Dialog(
          ...
          child: Stack(
            ...
            children: [
              // Banner Container
              GestureDetector(
                onTap: () {}, // Consume tap to prevent accidental dismiss on banner click
                child: ClipRRect(
