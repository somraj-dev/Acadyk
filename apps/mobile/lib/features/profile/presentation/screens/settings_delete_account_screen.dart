...
class SettingsDeleteAccountScreen extends StatefulWidget {
  ...
  @override
  State<SettingsDeleteAccountScreen> createState() => _SettingsDeleteAccountScreenState();
}

class _SettingsDeleteAccountScreenState extends State<SettingsDeleteAccountScreen> {
  ...
  Future<void> _handleDelete() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text(
          'We’ve sent an email with the final step to permanently delete your account.',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Closing your account means you won\'t be able to recover your posts and all your projects and certificates. All of your Acadyk account data will be permanently deleted.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: bodyColor,
                      fontSize: 16,
                  ...
                  const SizedBox(height: 36),
                  Text(
                    '$displayName, if you’re ready to leave forever, we’ll send an email with the final step to:',
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      color: bodyColor,
                      fontSize: 15.5,
