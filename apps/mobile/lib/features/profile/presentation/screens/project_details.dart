...
class _ProjectDetailsScreenState extends State<ProjectDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final custom = widget.projectData ?? widget.customData;
    final isCustom = custom != null && custom['title'] != 'Airbnb' && custom['companyName'] != null;

    final companyName = custom?['companyName'] ?? custom?['title'] ?? 'Airbnb';
    final descriptionText = custom?['description'] ??
    ...
    final urlText = custom?['url'] ?? custom?['website'] ?? 'http://airbnb.com';
    final progressText = custom?['progress'] ??
    ...
    final String? logoAsset = custom?['logoAsset'];
          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: logoAsset != null ? Colors.white : const Color(0xFFFF5A5F),
                        borderRadius: BorderRadius.circular(12),
                        border: logoAsset != null ? Border.all(color: const Color(0xFFE5E7EB)) : null,
                      ),
                      ...
                      child: logoAsset != null
                          ? ClipRRect(
                              ...
                              child: Image.asset(
                                ...
                                height: 44,
                                fit: BoxFit.contain,
                                errorBuilder: (_, __, ___) => _buildAirbnbLogo(size: 30, color: Colors.white),
                              ),
                            )
                          : _buildAirbnbLogo(size: 30, color: Colors.white),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            runSpacing: 6,
                            children: [
                              _buildYCBadge(isCustom ? (custom['batch'] ?? 'FALL 2026') : 'WINTER 2009'),
                              _buildStatusBadge(isCustom ? (custom['status'] ?? 'PUBLIC') : 'PUBLIC'),
                              if (isCustom) ...[
                                _buildTextBadge(locationText.toUpperCase()),
                                if (custom['tags'] != null)
                                  for (final tag in List<String>.from(custom['tags']))
                                    _buildTextBadge(tag.toUpperCase()),
                              ] else ...[
                ...
                // Headline
                Text(
                  isCustom ? (custom['headline'] ?? descriptionText) : 'Book accommodations around the world.',
                  style: const TextStyle(
                    fontSize: 18,
                ...
                Text(
                  isCustom
                      ? (custom['paragraphs'] != null ? custom['paragraphs'][0] : 'Progress: $progressText')
                      : 'Founded in August of 2008 and based in San Francisco, California, Airbnb is a trusted community marketplace for people to list, discover, and book unique accommodations around the world — online or from a mobile phone. Whether an apartment for a night, a castle for a week, or a villa for a month, Airbnb connects people to unique travel experiences, at any price point, in more than 33,000 cities and 192 countries. And with world-class customer service and a growing community of users, Airbnb is the easiest way for people to monetize their extra space and showcase it to an audience of millions.',
                  style: const TextStyle(
                    fontSize: 15,
                    height: 1.5,
                ...
                Text(
                  isCustom
                      ? (custom['paragraphs'] != null && custom['paragraphs'].length > 1
                          ? custom['paragraphs'][1]
                ...
                if (isCustom && custom['founders'] is List) ...[
                  for (final f in custom['founders'])
                    Padding(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSummaryRow('Batch:', isCustom ? (custom['batch'] ?? 'Fall 2026') : 'Winter 2009'),
                      const Divider(color: Color(0xFFECECE8), height: 24),

                      _buildSummaryRow('Team Size:', isCustom ? '1-5' : '6132'),
                      const Divider(color: Color(0xFFECECE8), height: 24),

                      _buildSummaryRow('Status:', isCustom ? (custom['status'] ?? 'Public') : 'Public', hasStatusDot: true),
                      const Divider(color: Color(0xFFECECE8), height: 24),
