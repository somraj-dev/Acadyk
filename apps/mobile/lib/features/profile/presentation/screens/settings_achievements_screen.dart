...
class SettingsAchievementsScreen extends StatefulWidget {
  ...
  @override
  State<SettingsAchievementsScreen> createState() => _SettingsAchievementsScreenState();
}

class _SettingsAchievementsScreenState extends State<SettingsAchievementsScreen> {
  final TextEditingController _titleCtrl = TextEditingController();
  final TextEditingController _descriptionCtrl = TextEditingController();
  final TextEditingController _skillsCtrl = TextEditingController();
  String? _linkedAchievement;
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildLargeTextField(
                    ...
                    hint: 'Describe your achievement here, emphasizing the skills you developed, the challenges you overcame, and the impact or significance of this accomplishment in your professional journey.',
                  ),

                  const SizedBox(height: 16),

                  // Link this Achievement
                  _buildDropdownField(
                    label: 'Link this Achievement',
                    isRequired: false,
                    hasInfoIcon: true,
                    value: _linkedAchievement,
                    items: ['Link this Achievement', 'Project Alpha', 'Work Experience at Google'],
                    onChanged: (val) => setState(() => _linkedAchievement = val),
                    hint: 'Link this Achievement',
                  ),
